...
export default function Account({
  ...
  return (
    <div className="h-full bg-brand-bg px-4 sm:px-6 pt-6 pb-32 space-y-4 max-w-4xl mx-auto w-full select-none overflow-y-auto">
      ...
      <div className="bg-gradient-to-r from-purple-50/90 via-white to-lime-50/70 text-slate-900 rounded-3xl p-5 border border-purple-200/80 space-y-4 shadow-xs relative overflow-hidden">
        ...
        <div className="flex items-center justify-between relative z-10">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-sm font-black text-slate-900">মোবাইল পুশ নোটিফিকেশন</h3>
              <p className="text-xs text-slate-600 font-medium">অ্যাপ বন্ধ থাকলেও সরাসরি ফোনে অ্যালার্ট পাবেন</p>
            </div>
          </div>
          <span className={`text-[10px] font-black uppercase px-2.5 py-1 rounded-full ${
            pushStatus === "granted" ? "bg-brand-lime text-slate-950 shadow-2xs" : "bg-slate-100 text-slate-600 border border-slate-200"
          }`}>
        ...
        <div className="flex flex-wrap items-center gap-2 pt-1 relative z-10">
          ...
          {pushStatus === "granted" && (
            <button
              ...
              className="px-3.5 py-2.5 rounded-xl text-xs font-bold bg-purple-50 hover:bg-purple-100 text-purple-800 border border-purple-200 transition-all flex items-center gap-1.5 cursor-pointer"
            >

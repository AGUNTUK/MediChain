              ...
              <div className="bg-amber-50/80 border border-amber-200/80 rounded-xl p-2.5 space-y-1 text-xs">
                <div className="flex items-center justify-between">
                  <span className="text-[9px] font-black text-amber-800 uppercase tracking-wider flex items-center gap-1">
                    ⚠️ সরবরাহজনিত সংশোধন ({order.amendments.length} টি আইটেম বাদ)
                  </span>
                  <span className="text-[8.5px] text-amber-700 font-bold bg-amber-100 px-1.5 py-0.5 rounded">বিল সমন্বয়কৃত (COD)</span>
                </div>
                <div className="text-[10px] text-amber-900 space-y-0.5">
                  {order.amendments.map((amend, aIdx) => (
                    <div key={aIdx} className="flex justify-between items-center">
                      <span className="truncate pr-1 text-slate-700 line-through">
                        • {amend.productName} ({amend.removedQuantity} বক্স)
                      </span>
                      <span className="text-[9px] text-amber-700 italic shrink-0">
                        {amend.reason || "হোলসেলার স্টকে অনুপলব্ধ"}
                      </span>
                    </div>
                  ))}
                </div>
